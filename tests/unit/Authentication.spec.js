'use strict';
describe('$angularFireUser', function () {

  var $firebase, $angularFireUser, $timeout, $rootScope, $utils;
  ...
  beforeEach(function() {
    ...
    inject(function (_$firebase_, _$angularFireUser_, _$timeout_, _$rootScope_, $firebaseUtils) {
      $firebase = _$firebase_;
      $angularFireUser = _$angularFireUser_;
      $timeout = _$timeout_;
  ...
  describe('<constructor>', function() {
    it('should accept a Firebase ref', function() {
      ...
      var auth = new $angularFireUser(ref);
      expect($fb.$ref()).toBe(ref);
    });

    xit('should throw an error if passed a string', function() {
      expect(function() {
        $firebase('hello world');
      }).toThrowError(/valid Firebase reference/);
    });

    xit('should accept a factory name for arrayFactory', function() {
      var ref = new Firebase('Mock://');
    ...
    xit('should accept a factory name for objectFactory', function() {
      var ref = new Firebase('Mock://');
      var app = angular.module('firebase');
    ...
    xit('should throw an error if factory name for arrayFactory does not exist', function()  {
      var ref = new Firebase('Mock://');
      expect(function() {
    ...
    xit('should throw an error if factory name for objectFactory does not exist', function()  {
      var ref = new Firebase('Mock://');
      expect(function() {
