...
angular
  ...
  firebaseConfig.$inject = ["$firebaseArray", "$firebaseObject", "$injector"];
  
  function firebaseConfig($firebaseArray, $firebaseObject, $injector) {
  ...
  firebaseUtils.$inject = ["$q", "$timeout", "$rootScope"];
  
  function firebaseUtils($q, $timeout, $rootScope) {
